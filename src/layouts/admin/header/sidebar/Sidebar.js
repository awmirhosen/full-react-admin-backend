...
const Sidebar = () => {
    return (
        <section id="sidebar_section">
            <div className="mini_sidebar collapsedd bg-black h-100" id='overflow-sidebar'>
                <ul className="p-0 m-0">
                    <li className="pt-1 pb-2 d-flex flex-column avatar_li position-relative">
                    <span className="avatar_box">
                        <img className="w-100 rounded-circle" src="/assets/images/avatar/user2.jpeg" />
                    </span>
                        <div className="sidebar_avatar_name text-center hiddenable mt-4">امیرحسین محمدی</div>
                    </li>
                    <li className="py-1 text-start pe-4 sidebar_menu_item mt-2 active"
                        data-section-id="dashboard_section">
                        <i className="ms-3 icon fas fa-tachometer-alt text-light" />
                    ...
                    <li className="py-1 text-start pe-4 sidebar_menu_item"
                        ...
                        <i className="ms-3 icon fas fa-question-circle text-light" />
                        <span className="hiddenable no_wrap font_08">سوال ها</span>
                    </li>
                    <li className="py-1 text-start pe-4 sidebar_menu_item"
                        data-section-id="manage_comments_section">
                        <i className="ms-3 icon fas fa-comment text-light" />
